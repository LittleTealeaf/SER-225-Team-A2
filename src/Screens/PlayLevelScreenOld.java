...
public class PlayLevelScreenOld extends Screen implements PlayerListener {
	...
	public PlayLevelScreenOld(ScreenCoordinator screenCoordinator) {
	...
	public PlayLevelScreenOld(ScreenCoordinator screenCoordinator, PlayLevelScreenState state) {
		this.screenCoordinator = screenCoordinator;

...
public class MenuScreen extends Menu {
    ...
    public MenuScreen() {
        ...
        MenuOption[][] menu = new MenuOption[][]{
                {
                        new MenuOption("PLAY GAME", 60, 100, () -> GamePanel.getScreenCoordinator().setGameState(GameState.LEVEL)), new MenuOption(
                        "LEVEL SELECT", 392, 100, () -> GamePanel.getScreenCoordinator().setGameState(GameState.LEVELSELECT))
                }, {
                        new MenuOption("CREDITS", 60, 200, () -> GamePanel.getScreenCoordinator().setGameState(GameState.CREDITS)), new MenuOption(
                "NARRATIVE", 392, 200, () -> GamePanel.getScreenCoordinator().setGameState(GameState.OPENING))
                }, {

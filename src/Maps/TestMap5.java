...
public class TestMap5 extends Map {
    ...
    public TestMap5() {
        super("Level 5", "test_map5.txt", new CommonTileset(), new Point(1, 11));
    }

    @Override
    public ArrayList<Enemy> loadEnemies() {
        ArrayList<Enemy> enemies = new ArrayList<>();
        enemies.add(new BugEnemy(getPositionByTileIndex(17, 9), Direction.LEFT));
    ...
    public ArrayList<EnhancedMapTile> loadEnhancedMapTiles() {
        ...
        enhancedMapTiles.add(new EndLevelBox(getPositionByTileIndex(35, 7)));
